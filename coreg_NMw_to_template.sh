...
brain_template=average_nonlin_10.nii
...
#direction
reg_resample -flo $NMw_img -ref $T1w_img -aff $outDir/rT1_NMw_mat_rigid.txt -res $outDir/rT1_NMw_rigid.nii
...
reg_resample -flo $SN_ROI -ref $T1w_img -aff $outDir/rT1_NMw_mat_rigid.txt -res $outDir/rT1_SN_ROI.nii -inter 0

#Calculating the affine+nonlinear transformation from T1w to template
reg_aladin -flo $brain_T1w_img -ref $brain_template -aff $outDir2/rSymmTemplate_T1w_mat_affine.txt -res $outDir2/rSymmTemplate_T1w_affine.nii
reg_f3d -flo $brain_T1w_img -ref $brain_template -aff $outDir2/rSymmTemplate_T1w_mat_affine.txt -res $outDir2/rSymmTemplate_T1w_nonlinear.nii -cpp $outDir2/rSymmTemplate_T1w_cpp_nonlinear.nii

#Applying the T1w-to-template transformation to the TSE image and the segmentations (in T1w space)
reg_resample -ref $brain_template -flo $outDir/rT1_NMw_rigid.nii -cpp $outDir2/rSymmTemplate_T1w_cpp_nonlinear.nii -res $outDir3/rSymmTemplate_rT1_NMw_nonlinear.nii
reg_resample -ref $brain_template -flo $outDir/rT1_SN_ROI.nii -cpp $outDir2/rSymmTemplate_T1w_cpp_nonlinear.nii -res $outDir3/rSymmTemplate_rT1_SN_ROI.nii -inter 0
